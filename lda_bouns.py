...
Original file is located at
    https://colab.research.google.com/drive/1tabXttkzYRsXMf7-cJ1QcxsQoYg_grC3
"""
...
def generate_dataMatrix_labelVector():
    ...
    src = '/content/drive/My Drive/Colab Notebooks/orl_faces'
...
if __name__ == "__main__":
    ...
    for z in range(0,280,7):
        D = Dtrain[range(z,z+7), :]
        print(D.shape)
        #D.reshape(5,10304)
...
for key in my_dict_for_mean:
        ...
        between_class_scatter_matrix = between_class_scatter_matrix + (7 * (np.dot(mean_deviation, mean_deviation_transpose)))
